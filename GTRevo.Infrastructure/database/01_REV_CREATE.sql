...
CREATE TABLE [dbo].[REV_APNS_EXTERNAL_USER_DEVICE_TOKEN] (
	[REV_GET_ApnsExternalUserDeviceTokenId] [UNIQUEIDENTIFIER] NOT NULL,
	[REV_GET_Ordinal] [INT] IDENTITY(1,1) NOT NULL,
	[REV_GET_Version] [INT] NOT NULL,
	[REV_GET_ExternalUserId] [UNIQUEIDENTIFIER] NOT NULL,
	[REV_GET_DeviceToken] [NVARCHAR] (MAX) NOT NULL,
	[REV_GET_AppId] [VARCHAR] (255) NOT NULL,
	[REV_GET_IssuedDateTime] [DATETIME] NOT NULL
	CONSTRAINT [REV_APNS_EXTERNAL_USER_DEVICE_TOKEN_PK] PRIMARY KEY NONCLUSTERED ([REV_GET_ApnsExternalUserDeviceTokenId])
);
GO
...
CREATE TABLE [dbo].[REV_FCM_USER_DEVICE_TOKEN] (
	...
	[REV_FUT_DeviceToken] [NVARCHAR] (MAX) NOT NULL,
...
CREATE TABLE [dbo].[REV_FCM_EXTERNAL_USER_DEVICE_TOKEN] (
	...
	[REV_FET_DeviceToken] [NVARCHAR] (MAX) NOT NULL,
