...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'REV_DICTIONARY')
CREATE TABLE [dbo].[REV_DICTIONARY] (
	[REV_DIC_DictionaryId] [UNIQUEIDENTIFIER],
	[REV_DIC_Ordinal] [INT] IDENTITY(1,1),
	[REV_DIC_Version] [INT] NOT NULL,
	[REV_DIC_ClassName] [VARCHAR](1024) NOT NULL,
	[REV_DIC_Key] [NVARCHAR](255) NOT NULL,
	[REV_DIC_Translation] [NVARCHAR](MAX),
	[REV_DIC_Culture] [VARCHAR](128) NOT NULL,
	CONSTRAINT [REV_DICTIONARY_PK] PRIMARY KEY NONCLUSTERED ([REV_DIC_DictionaryId])
);
GO