...
CREATE TABLE IF NOT EXISTS rno_apns_user_device_token (
...
CREATE TABLE IF NOT EXISTS rno_apns_external_user_device_token (
...
CREATE TABLE IF NOT EXISTS rno_fcm_user_device_token (
...
CREATE TABLE IF NOT EXISTS rno_fcm_external_user_device_token (
