...
namespace Revo.Core.ValueObjects
{
    public static class CollectionAsValueExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<T> AsValueObject<T>(this IImmutableList<T> list) => new ListAsValue<T>(list);
        ...
        /// </summary>
        public static IEnumerable<T> AsValueObject<T>(this ImmutableArray<T> array) => new ListAsValue<T>(array);
        ...
        /// </summary>
        public static IEnumerable<T> AsValueObject<T>(this IImmutableSet<T> set) => new SetAsValue<T>(set);
        ...
        public static IReadOnlyDictionary<TKey, TValue> AsValueObject<TKey, TValue>(this IImmutableDictionary<TKey, TValue> dictionary) =>
            new DictionaryAsValue<TKey, TValue>(dictionary);
    }
}
