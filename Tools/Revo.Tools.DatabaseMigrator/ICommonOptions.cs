...
namespace Revo.Tools.DatabaseMigrator
{
    public interface ICommonOptions
    {
        ...
        [Option('m', "modules", Required = false, HelpText = "Names of modules to migrate. If empty, will migrate all found modules. May also specify the target version of every module like this: 'module1@1.2.3'.;")]
